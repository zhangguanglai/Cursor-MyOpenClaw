...
async def main():
    if len(sys.argv) < 2:
        print("用法: python generate_testing_view_plan.py <case_id>")
        return
    ...
    request = {
        ...
        "related_files": [
            "openclaw-studio-frontend/src/features/testing/TestingView.tsx",
            "openclaw-studio-frontend/src/services/testing.ts",
